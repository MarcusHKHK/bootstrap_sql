    ...
    <div class="container">
        <div class="row py-5">
            <div class="col-sm-6 bg-secondary rounded-start">
              <div class="container bg-dark rounded text-white my-3">
                <h1>Auto:</h1>
                <p>
                <?php echo $rida[1]." ".$rida[2] ?><br>
                </p>
                <p>
                Andmed:<br>
                Mootor: <?php echo $rida[3]; ?><br>
                Kütus: <?php echo $rida[4]; ?><br>
                Käigukast: <?php echo $rida[9] ?><br>
                Istekohad: <?php echo $rida[8] ?><br>
                Auto staatus: <?php echo $rida[11] ?><br>
                Auto kirjeldus: <?php echo $rida[10] ?><br>
                </p>
                <h2>Kalkulaator</h2>
            ...
            <div class="col-sm-6 bg-secondary rounded-end centered">
              <div class="container my-3">
                <img class="rounded" src="https://loremflickr.com/575/420/<?php echo $rida[1]; ?>" alt="auto">
              </div>
            </div>
        </div>        
    </div>
