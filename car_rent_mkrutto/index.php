...
<div class="container py-4">
  <div class="hero bg-body-tertiary p-4 rounded">
    <div class="row  d-flex">
      ...
      <div class="col-sm-6">
        <img class="image-fluid rounded" src="https://loremflickr.com/600/250/mustang" alt="autopilt">
      </div>
    </div>
  </div>
</div>
        ...
        while($rida = mysqli_fetch_row($valjund)){ 
            ...
            <div class="col-sm-3">
              <div class="card my-2" style="width: 19rem;">
                <img src="https://loremflickr.com/600/350/<?php echo $rida[1]; ?>" class="card-img-top rounded-top" alt="auto">
                <div class="card-body rounded-bottom text-white bg-dark">
                  <div class="row">
                  ...
                  <a href="http://localhost/car_rent_mkrutto/car.php?car_id=<?php echo $rida[0]; ?>&rtime=1" class="btn btn-dark w-100 border">Rendi</a>
                </div>
              </div>
            </div>
            <!-- /kaart -->
